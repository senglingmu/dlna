		...
		InputStream in = null;
 		...
 		try {
 			if (postSocket == null){
				...
				postSocket.connect(new InetSocketAddress(host, port), HTTP.DEFAULT_TIMEOUT*1000);
 			}
			...
			httpRes.setStatusCode(HTTPStatus.REQUEST_TIMEOUT);
			if(Debug.isOn()) Debug.warning(e);
