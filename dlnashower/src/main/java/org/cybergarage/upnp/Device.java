...
public class Device implements org.cybergarage.http.HTTPRequestListener, SearchListener
{
	...
	public final static int HTTP_DEFAULT_PORT = 4005;
	...
	public String getAbsoluteURL(String urlString)
	{
        ...
        //zhangbo@2013-7-9 using the follow content in jar replace the code in sources. 
	...
	{
		return (SystemClock.elapsedRealtime() - getTimeStamp()) / 1000;
	}
